...
\usepackage{csquotes}
\usepackage[sortcites, backend=biber, citestyle=numeric, style=numeric, sorting=none]{biblatex}
...
\makeatletter
\renewcommand{\ALG@name}{Algoritmo} %Change the name Algorithm to Algoritme
\makeatother
...
\input{capitulos/02_FundamentosTeoricos}

\input{capitulos/03_EstadoDelArte}

\input{capitulos/04_MaterialesYMetodos}

\input{capitulos/05_Experimentos}

\input{capitulos/06_Conclusiones}

\input{apendices/busquedas_scopus}
